...
import useBillExpense from "@/composables/billexpense/useBillExpense";
...
export default defineComponent({
  ...
  setup() {
    ...
    const { getList,tableData ,pagination,handleSizeChange,handleCurrentChange,onQuery} = useBillExpense()
    onMounted(() => {
      getList()
    })
    const count = ref(1)
